...
public class ScoreGradeTest { 
    ...
    void set()throws ScoreException,GradeException{
        ...
        if (grade == 'A') {} else if(grade == 'B'){} else if (grade == 'C'){}
        else if (grade == 'D'){} else if (grade == 'F'){} else {
            throw new GradeException("Invalid Grade"); }
    }
    total;
    int
    void check_grade() throws GradeException{
        total=(score[0] + score[1] + score[2]) / 3; char
        calc_grade = 'F'; 
        calc_grade = 'A';
    } 
    calc_grade = 'B';
...
if (calc_grade == grade){
    System.out.println("entered data is successfully verified and saved");} else
